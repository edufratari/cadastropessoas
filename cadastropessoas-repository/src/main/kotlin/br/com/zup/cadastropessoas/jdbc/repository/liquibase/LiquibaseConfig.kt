...
open class LiquibaseConfig @Autowired constructor(val datasource: DataSource, val liquibaseProperties: LiquibaseProperties,
                                                  val tenantDiscoverer: TenantDiscoverer, val multiTenantProperties: MultiTenantProperties) {

    private val logger = LoggerFactory.getLogger(br.com.zup.cadastropessoas.jdbc.repository.liquibase.LiquibaseConfig::class.java)
    ...
    open fun liquibase(): MultiTenantSpringLiquibase {
        ...
        liquibase.schemas = tenantDiscoverer.getTenants(multiTenantProperties.prefix).get() + liquibaseProperties.defaultSchema
